...
- A [bare unit](https://github.com/i2van/hourglass/blob/main/FAQ.md#what-formats-are-supported-when-entering-a-duration-or-date-and-time) (e.g. `hour`, `day`, `week`) starts a 1-unit timer without a leading number.
...
- The **Advanced options** / **Open settings file location** timer window context menu command opens the [settings file location](https://github.com/i2van/hourglass/blob/main/FAQ.md#how-to-find-the-hourglass-settings) in Windows Explorer.
