...
public sealed class TimeSpanTokenTest
{
    ...
    public void ParseWithNullInputThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        Assert.ThrowsExactly<ArgumentNullException>(() => TimeSpanToken.Parser.Instance.Parse(null /* str */, provider));
    }
    ...
    public void ParseWithEmptyInputThrowsFormatException()
    {
        ...
        // Act & Assert
        Assert.ThrowsExactly<FormatException>(() => TimeSpanToken.Parser.Instance.Parse(str, provider));
    }
